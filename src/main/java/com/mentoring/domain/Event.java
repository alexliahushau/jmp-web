...
import com.mentoring.jackson.AuditoriumsDeserializer;
import com.mentoring.jackson.LocalDateTimeNavigableSetDeserialiser;
...
public class Event extends DomainObject {
    ...
    @JsonDeserialize(using=LocalDateTimeNavigableSetDeserialiser.class)
    ...
    @JsonDeserialize(keyUsing = AuditoriumsDeserializer.class)
    ...
    public String toString() {
        return "Event[id:" + this.getId() + ", name:" + name + ", airDates:" + airDates + ", basePrice:" + basePrice + ", rating:" + rating
